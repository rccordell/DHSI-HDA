...
The code below loads documents from the Viral Texts project. Let's work through what this code is doing together, load the documents, and then we will ask you to see if you can reproduce the topic modeling above using this new data. 
